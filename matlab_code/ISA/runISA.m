rootdir = './CorrTol0.001Bad/';

opts.parallel.flag = false;
opts.parallel.ncores = 5;
...
opts.selvars.smallscale = 0.01;     % Percentage of instances to be kept for a small scale experiment
...
opts.sifted.K = 20;                 % Number of final features. Ideally less than 10.
